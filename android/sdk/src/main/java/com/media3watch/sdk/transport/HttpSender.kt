...
internal class HttpSender(
    ...
    suspend fun send(json: String, callTimeoutMs: Long? = null): SendResult =
    ...
    companion object {
        ...
        /**
         * Shared [okhttp3.OkHttpClient] instance. OkHttp's best practice is a single client per
         * application, reusing the connection pool and thread pool across all callers.
         * This is especially important when multiple [com.media3watch.sdk.Media3WatchAnalytics] instances
